...
/**
* Point d'entr̩e du m̩canisme de gestion g̩n̩rique des briques de r̩gulation
*/
...
public:
    ...
    // ex̩cute les briques de r̩gulation pou le pas de temps ̩coul̩
    void run();
...
private:
    ...
    // Liste des briques de r̩gulation utilis̩es
    std::vector<RegulationBrique*> m_LstBriquesRegulation;

    // Brique de r̩gulation dont les actions sont en cours d'ex̩cution
