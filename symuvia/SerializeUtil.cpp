...
void registerClasses(Archive & ar)
{
  ...
  /*  ar.register_type(static_cast<Tuyau *>(NULL));
    ...
    ar.register_type(static_cast<EdieSensorData *>(NULL));
    boost::serialization::void_cast_register(static_cast<EdieSensorData *>(NULL),static_cast<AbstractSensorSnapshot *>(NULL));
